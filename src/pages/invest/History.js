                            ...
                            {buy_funds.map((buy_fund, index) => (
                                ...
                                <uni-view data-v-b0a5c882="" class="item">
                                    <uni-view data-v-b0a5c882="" class="first">
                                        <uni-view data-v-b0a5c882="" class="left">{buy_fund.transaction_id && buy_fund.transaction_id.length > 20 ? buy_fund.transaction_id.substring(0, 20) + "..." : buy_fund.transaction_id}
</uni-view>
                                        <uni-view
                                            data-v-b0a5c882=""
                                            style={{
                                        ...
                                        >
                                            {buy_fund.status=='Active'?'Completed':buy_fund.status}
                                        </uni-view>
                                    ...
                                    <uni-view data-v-b0a5c882="" class="layout">
                                        ...
                                        <uni-view data-v-b0a5c882="" class="value">{buy_fund.payment_mode}</uni-view>
                                    </uni-view>
                                </uni-view>
                            ))}
