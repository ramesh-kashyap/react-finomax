                                ...
                                <uni-view data-v-b7bb70a2="" class="top-box">
                                    <uni-view data-v-636c600c="" data-v-b7bb70a2="" class="uni-row" style={{ marginLeft: '0px', marginRight: '0px' }}>
                                        <uni-view data-v-35b9a113="" data-v-b7bb70a2="" class="uni-col uni-col-6" style={{ paddingLeft: '0px', paddingRight: '0px' }} >
                                            <uni-view data-v-b7bb70a2="" class="back"onClick={backClick}><img data-v-b7bb70a2="" src="/static/img/back.png" alt="" style={{ width: '35px',filter:'brightness(6) invert(0)'  }} /></uni-view>

                                        </uni-view>
                                        <uni-view data-v-35b9a113="" data-v-b7bb70a2="" class="uni-col uni-col-12" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
                                            <uni-view data-v-b7bb70a2="" class="page-title">{t('Wallet')}</uni-view>
                                        </uni-view>
                                        <Link to="/add-wallet">
                                            <uni-view data-v-35b9a113="" data-v-b7bb70a2="" class="uni-col uni-col-6" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
                                                <uni-view data-v-b7bb70a2="" style={{ display: 'flex', justifyContent: 'end', marginRight: '10px' }}><img data-v-b7bb70a2="" src="/static/img/add.png" alt="ad" style={{ width: '33px',filter:'brightness(5) invert(0)'  }} /></uni-view>
                                            </uni-view>
                                        </Link>
                                    </uni-view>
                                </uni-view>
                                 ...
                                 <uni-view data-v-b7bb70a2="" class="wallet-box"style={{ display: 'flex', flexDirection: 'column' }}>
                                    {walletList.some(item => item.address) ? (
                                        ...
                                        <uni-view data-v-b7bb70a2="" style={{ display: 'flex', justifyContent: 'end', marginRight: '10px' }}></uni-view>
