        ...
        <div class=" ">
            <uni-app class="">
                ...
                <uni-page data-page="pages/user/withdrawalRecords"> <uni-page-wrapper><uni-page-body><uni-view data-v-b0a5c882="" class="page"><uni-view data-v-b0a5c882="" class="ellipse"></uni-view><uni-view data-v-b0a5c882="" class="top-box"><uni-view data-v-636c600c="" data-v-b0a5c882="" class="uni-row" style={{ marginLeft: '0px', marginRight: '0px' }}><uni-view data-v-35b9a113="" data-v-b0a5c882="" class="uni-col uni-col-6" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
                        ...
                        <uni-view data-v-53c5f33f="" class="back"onClick={backClick}><img data-v-53c5f33f="" src="/static/img/back.png" alt="" style={{ width: '35px', marginTop: '5px',filter: 'brightness(6) invert(0)' }} /></uni-view>

              
                </uni-view>
                    <uni-view data-v-35b9a113="" data-v-b0a5c882="" class="uni-col uni-col-12" style={{ paddingLeft: '0px', paddingRight: '0px' }}><uni-view data-v-b0a5c882="" class="page-title">{t('Withdraw Records')}</uni-view></uni-view>
                            ...
                            {withdraws.map((withdraw, index) => (
                                ...
                                <uni-view data-v-b0a5c882="" class="item">
                                    ...
                                    <uni-view data-v-b0a5c882="" class="layout">
                                        <uni-view data-v-b0a5c882="" class="title">{t('Create Time')}</uni-view>
                                        <uni-view data-v-b0a5c882="" class="value">{new Date(withdraw.created_at).toLocaleDateString()}</uni-view>
                                    </uni-view>
                                    <uni-view data-v-b0a5c882="" class="layout">
                                        <uni-view data-v-b0a5c882="" class="title">{t('Amount')}</uni-view>
                                        <uni-view data-v-b0a5c882="" class="value">{withdraw.amount} USDT</uni-view>
                                    </uni-view>
                                    <uni-view data-v-b0a5c882="" class="layout">
                                        <uni-view data-v-b0a5c882="" class="title">{t('Type')}</uni-view>
