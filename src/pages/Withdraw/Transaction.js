...
const Transaction = () => {
    ...
    const getAmountPrefix = (type) => {
        return type === 'buyfund' || type === 'income' || type === 'investment' ? '+ ' : '- ';
    };
    ...
    const revenueOptions = ['All','Deposits','Withdrawal','Order Revenue','Task Income','Rapid Rise Bonus','Community Building Reward','Monthly Fixed Income','Over Rise Income','Team Commission',];
 ...
 */}
                                ...
                                <div style={containerStyle}>
                                    <div style={labelStyle}>{t('Revenue Distribution')}</div>
