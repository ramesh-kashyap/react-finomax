...
const Transaction = () => {
    ...
    const revenueOptions = ['All','Deposits','Withdrawal', 'Mentor Fee','Order Revenue','Over Rise Income','Rapid Rise Bonus','Community Building Reward','Monthly Fixed Income',];
